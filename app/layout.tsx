...
export const metadata:Metadata={title:'IAtelier — De l’intelligence à l’action',description:'Formation en intelligence artificielle et marketing immobilier au Québec. Parcours guidés, prompts ChatGPT, exercices et accompagnement.'};
